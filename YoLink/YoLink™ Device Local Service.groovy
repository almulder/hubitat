    ...
    dynamicPage(name: "credentials", title: pageTitle("YoLink™ Access Credentials"), uninstall: false) {
        ...
        section("") {
            ...
            if (settings.showInstructions) {
                ...
                paragraph "<img src='https://raw.githubusercontent.com/almulder/hubitat/main/pics/Yolink/devices.png' alt='YoLink devices' style='max-width: 50%; height: auto; border: 2px solid gray; box-shadow: 4px 4px 6px rgba(0,0,0,0.5);'/>"
                paragraph ""
                paragraph ""
                paragraph ""
                paragraph "<b>◉</b>  Click on the 3 dots (1) in the top right corner."
                paragraph "<img src='https://raw.githubusercontent.com/almulder/hubitat/main/pics/Yolink/hub.png' alt='YoLink devices' style='max-width: 50%; height: auto; border: 2px solid gray; box-shadow: 4px 4px 6px rgba(0,0,0,0.5);'/>"
                paragraph ""
                paragraph ""
                paragraph ""
                ...
                paragraph "<img src='https://raw.githubusercontent.com/almulder/hubitat/main/pics/Yolink/details.png' alt='YoLink devices' style='max-width: 50%; height: auto; border: 2px solid gray; box-shadow: 4px 4px 6px rgba(0,0,0,0.5);'/>"
                paragraph ""
                paragraph ""
                paragraph ""
                ...
                paragraph "<img src='https://raw.githubusercontent.com/almulder/hubitat/main/pics/Yolink/local_network.png' alt='YoLink devices' style='max-width: 50%; height: auto; border: 2px solid gray; box-shadow: 4px 4px 6px rgba(0,0,0,0.5);'/>"
                paragraph ""
                paragraph ""
                paragraph ""
                paragraph "<b>◉  Client ID & Client Secret:</b> Go to the Integrations tab and locate the Client ID and Client Secret."
                paragraph "<img src='https://raw.githubusercontent.com/almulder/hubitat/main/pics/Yolink/local_api.png' alt='YoLink devices' style='max-width: 50%; height: auto; border: 2px solid gray; box-shadow: 4px 4px 6px rgba(0,0,0,0.5);'/>"
                paragraph ""
                paragraph ""
                paragraph ""
